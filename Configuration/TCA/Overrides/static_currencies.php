...
foreach ($additionalFields as $sourceField => $destField) {
	...
	$additionalColumns[$destField]['label'] = 'LLL:EXT:static_info_tables_nl/Resources/Private/Language/locallang_db.xlf:static_currencies_item.' . $destField;
